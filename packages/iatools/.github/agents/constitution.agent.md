---
name: constitution
description: Master constitution for all AI agents working on iatools. Defines hard rules, SDD workflow phases, and quality gates.
---

# Agent Constitution — iatools

**Project**: iatools  
**Setup date**: 2026-02-24  
**Roles active**: Backend Developer  
