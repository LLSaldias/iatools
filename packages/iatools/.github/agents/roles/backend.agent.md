---
name: role-backend
description: Backend developer persona for iatools. Focuses on API contracts, domain events, NestJS patterns, and performance.
---

# Role: Backend Developer — iatools
