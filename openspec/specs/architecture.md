# Architecture Spec — card-building-framework
...
card-building-framework is a Lerna monorepo managing multiple TypeScript packages published to the JFrog registry.
